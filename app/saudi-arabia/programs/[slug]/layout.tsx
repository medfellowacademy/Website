...
export async function generateMetadata({ params }: ProgramMetadataProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: `fellowship, ${slug.replace(/-/g, " ")}, Saudi Arabia, SCFHS, online learning, medical training`,
    robots: { index: true, follow: true },
    alternates: { canonical: `https://www.medfellowacademy.com/saudi-arabia/programs/${slug}` },
    openGraph: {
      title: meta.title,
      description: meta.description,
      type: "website",
