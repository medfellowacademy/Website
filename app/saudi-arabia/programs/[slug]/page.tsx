...
export default function SaudiProgramDetail(props: ProgramPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-8 sm:py-10 md:py-12" style={{ background: '#e8f2ea' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-semibold mb-1" style={{ color: '#15401E' }}>46+</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl" style={{ border: '1px solid #E5E7EB' }}>
              <h3 className="text-xl font-semibold mb-6" style={{ color: '#15401E' }}>Career Opportunities in Saudi Arabia</h3>
              <div className="grid md:grid-cols-2 gap-4">
                {program.whySaudi.opportunities.map((opportunity, index) => (
                  <div key={index} className="flex gap-3">
                    <Check className="w-5 h-5 shrink-0" style={{ color: '#52BE80' }} />
                    <span className="text-sm" style={{ color: '#6B7280' }}>{opportunity}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold" style={{ color: '#15401E' }}>
              What You Will Gain
            </h2>
          </div>
            ...
            {program.highlights.map((highlight, index) => (
              <div key={index} className="bg-white rounded-xl p-5" style={{ border: '1px solid #D5DBDB' }}>
                <div className="flex items-start gap-3">
                  <Award className="w-5 h-5 shrink-0 mt-0.5" style={{ color: '#15401E' }} />
                  <p className="text-sm leading-relaxed" style={{ color: '#6B7280' }}>{highlight}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            {program.curricula.map((block, index) => (
              <div key={index} className="bg-white rounded-2xl p-6" style={{ border: '1px solid #D5DBDB' }}>
                <div className="flex items-center gap-2 mb-2">
                  <Clock className="w-4 h-4" style={{ color: '#15401E' }} />
                  <span className="text-sm font-medium" style={{ color: '#15401E' }}>{block.month}</span>
                </div>
                <h3 className="text-xl font-semibold mb-4" style={{ color: '#15401E' }}>{block.title}</h3>
                <div className="space-y-3">
                  {block.modules.map((module, moduleIndex) => (
                    <div key={moduleIndex} className="flex gap-3">
                      ...
                      <p className="text-sm" style={{ color: '#6B7280' }}>{module}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {/* Career Outcomes */}
      <section className="py-16" style={{ background: '#e8f2ea' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6">
          <div className="text-center mb-10">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-4" style={{ background: 'white', color: '#15401E' }}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {program.careerOutcomes.map((item, index) => (
              <div key={index} className="bg-white rounded-2xl p-6" style={{ border: '1px solid #D5DBDB' }}>
                <h3 className="text-xl font-semibold mb-3" style={{ color: '#15401E' }}>{item.role}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="rounded-2xl p-8 bg-white" style={{ border: '1px solid #D5DBDB' }}>
              <h3 className="text-2xl font-semibold mb-2" style={{ color: '#15401E' }}>Online Format</h3>
              <p className="text-sm mb-4" style={{ color: '#6B7280' }}>{program.pricing.onlineFormat.format}</p>
              <p className="text-3xl font-semibold mb-2" style={{ color: '#15401E' }}>{program.pricing.onlineFormat.price}</p>
              <p className="text-sm" style={{ color: '#15401E' }}>{program.pricing.onlineFormat.sar}</p>
            </div>
            <div className="rounded-2xl p-8 text-white" style={{ background: 'linear-gradient(135deg, #15401E 0%, #15401E 100%)' }}>
          ...
          <div className="grid md:grid-cols-5 gap-4">
            {program.applicationProcess.map((step) => (
              <div key={step.step} className="bg-white rounded-xl p-5" style={{ border: '1px solid #D5DBDB' }}>
                <div className="w-8 h-8 rounded-full mb-3 flex items-center justify-center text-sm font-semibold text-white" style={{ background: '#15401E' }}>
                  {step.step}
                </div>
                <h3 className="font-semibold mb-2 text-sm" style={{ color: '#15401E' }}>{step.title}</h3>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-5 md:px-6">
          ...
          <div className="overflow-x-auto rounded-2xl" style={{ border: '1px solid #D5DBDB' }}>
            <table className="w-full bg-white">
              <thead style={{ background: '#e8f2ea' }}>
                <tr>
                  <th className="p-4 text-left text-sm font-semibold" style={{ color: '#15401E' }}>Criteria</th>
                  <th className="p-4 text-left text-sm font-semibold" style={{ color: '#15401E' }}>MedFellow</th>
                  <th className="p-4 text-left text-sm font-semibold" style={{ color: '#15401E' }}>Typical Alternatives</th>
                </tr>
              </thead>
              <tbody>
                {program.compareRows.map((row, index) => (
                  <tr key={index} style={{ borderTop: '1px solid #ECF0F1' }}>
                    <td className="p-4 text-sm font-medium" style={{ color: '#15401E' }}>{row[0]}</td>
                    <td className="p-4 text-sm" style={{ color: '#15401E' }}>{row[1]}</td>
                    <td className="p-4 text-sm" style={{ color: '#6B7280' }}>{row[2]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <p className="text-sm mt-4 text-center" style={{ color: '#6B7280' }}>{program.compareTakeaway}</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {program.testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white rounded-2xl p-8" style={{ border: '1px solid #D5DBDB' }}>
                ...
                <div>
                  <p className="font-semibold" style={{ color: '#15401E' }}>{testimonial.author}</p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-5 md:px-6">
          <h2 className="text-3xl md:text-4xl font-semibold mb-12 text-center" style={{ color: '#15401E' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-5 md:px-6">
          <div className="p-12 rounded-3xl text-center text-white" style={{ background: 'linear-gradient(135deg, #15401E 0%, #15401E 100%)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/apply" className="px-8 py-3 bg-white text-[#15401E] rounded-lg font-medium hover:opacity-90 transition-all inline-flex items-center justify-center gap-2">
                Apply Now
                <ArrowRight className="w-4 h-4" />
              </Link>
              <Link href="/contact" className="px-8 py-3 border-2 border-white text-white rounded-lg font-medium hover:bg-white transition-all hover:text-[#15401E] inline-flex items-center justify-center gap-2">
                Schedule Consultation
              </Link>
            </div>
          </div>
