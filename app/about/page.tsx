    ...
    <div className="min-h-screen">
      ...
      <section className="bg-linear-to-br from-primary to-primary-dark text-white py-12 md:py-20">
        <div className="container-custom text-center">
          <h1 className="text-3xl md:text-5xl font-heading font-bold mb-4 md:mb-6">About Med Fellow Academy</h1>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="bg-background rounded-2xl p-6 md:p-12">
            <h2 className="text-2xl md:text-4xl font-heading font-bold text-primary mb-8 md:mb-12 text-center">Why Choose Med Fellow Academy</h2>
