...
const STATIC_PROGRAMS: ProgramCard[] = [
  ...
  { name: "Fellowship in Clinical Cardiology", slug: "fellowship-in-clinical-cardiology", icon: "❤️", duration: "12 Months", eligibility: "MBBS/MD General Medicine", description: "Specialized training in cardiovascular disease management", highlights: ["ECG Interpretation", "Echo Cardiography", "Cardiac Emergencies"] },
