            ...
            {faculty.map((member, index) => (
              <div key={index} className="card p-6 hover:shadow-xl transition-all group">
                <div className="flex flex-col items-center text-center mb-4">
                  {/* Avatar */}
                  <div className="w-24 h-24 bg-linear-to-br from-primary to-secondary rounded-full flex items-center justify-center text-white text-2xl font-heading mb-4 group-hover:scale-110 transition-transform">
                    {member.image}
                  </div>
