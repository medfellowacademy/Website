...
import { ArrowRight, Check, Globe, Award, Clock, Star, Sparkles, Heart, Users, Phone, Mail, MessageCircle } from "lucide-react";
  ...
  const faqs = [
    {
      ...
      answer: "MedFellow Academy fellowship certificates are India issued specialty credentials. They strengthen the specialty training section of a DHA specialist application, but they do not replace DHA licensing exams. Every DHA credentialed specialist role in Dubai requires the official DHA licensing pathway. What the fellowship does is add a structured, documented specialty credential to the CV that DHA reviewers weigh during specialist categorisation. Fellows practising in Dubai consistently report that the certificate accelerates the specialist categorisation review when submitted alongside MBBS and MD documents."
    },
    {
      question: "Can I continue practising in Dubai during the fellowship?",
      answer: "Yes. The entire 12-month curriculum is delivered online with recorded sessions, live weekly interactions, and flexible assignments. Dubai-based doctors typically spend 8-12 hours per week on coursework, scheduled around their clinic hours. You never need to leave Dubai for the fully online format. If you choose the hybrid format, the 1-month India clinical rotation can be scheduled during your annual leave or planned around low patient volume weeks at your practice."
    },
    {
      question: "How does MedFellow compare to Medline Academics for Dubai based doctors?",
      answer: "The two providers serve different needs. MedFellow offers 46 specialties delivered fully online with optional hybrid rotation, which suits Dubai doctors who want breadth of specialty choice and zero travel disruption. Medline Academics, based in Bengaluru, focuses deeply on Reproductive Medicine, Andrology, and Embryology with hybrid or offline delivery that requires travel to Bengaluru for practical components. If you are set on IVF or embryology specifically and can travel, Medline is a strong choice. If you want flexibility across multiple specialties, MedFellow is the better fit."
    },
    {
      ...
      <section className="py-8 sm:py-10 md:py-12" style={{ background: '#e8f2ea' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-semibold mb-1" style={{ color: '#15401E' }}>4,200+</div>
              <div className="text-xs md:text-sm" style={{ color: '#6B7280' }}>Doctors Trained Globally</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-semibold mb-1" style={{ color: '#15401E' }}>22+</div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all" style={{ border: '1px solid #E5E7EB' }}>
                <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-6" style={{ background: '#e8f2ea' }}>
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4" style={{ color: '#15401E' }}>DHA raised the bar</h3>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all" style={{ border: '1px solid #E5E7EB' }}>
                ...
                <h3 className="text-xl font-semibold mb-3" style={{ color: '#15401E' }}>Where Dubai hires</h3>
                <p className="text-sm leading-relaxed" style={{ color: '#6B7280' }}>
      ...
      <section className="py-12 sm:py-16 md:py-20" style={{ background: '#F2F3F4' }}>
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="p-10 rounded-2xl text-white text-center" style={{ background: 'linear-gradient(135deg, #15401E 0%, #15401E 100%)' }}>
            ...
            <Link href="/dubai/programs" className="inline-flex items-center gap-2 px-8 py-4 bg-white rounded-lg font-medium hover:opacity-90 transition-all shadow-lg" style={{ color: '#15401E' }}>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold mb-4" style={{ color: '#15401E' }}>
                7 Priority Specialties for<br/>Dubai Based Doctors
              </h2>
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
                Which fellowships deliver the highest career return for your Dubai practice
              </p>
            </div>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  demandDriver: "Dubai medical tourism sector prioritises fertility care. Private IVF clinics are expanding rapidly",
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
                Two India based fellowship providers compared for Dubai doctors
              </p>
            </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderBottom: '1px solid #E5E7EB' }}>
                      <td className="px-6 py-4 text-sm" style={{ color: '#15401E' }}>Fit for Dubai Working Doctors</td>
                    ...
                    <tr style={{ borderBottom: '1px solid #E5E7EB' }}>
                      <td className="px-6 py-4 text-sm" style={{ color: '#15401E' }}>DHA CV Positioning</td>
            ...
            <div className="mt-8 p-6 rounded-xl" style={{ background: '#e8f2ea', border: '1px solid #C8E6D0' }}>
              <p className="text-sm font-medium mb-2" style={{ color: '#15401E' }}>The Practical Takeaway for Dubai Doctors</p>
              <p className="text-sm" style={{ color: '#6B7280' }}>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm" style={{ color: '#6B7280' }}>Real clinical scenarios you encounter in Dubai practice</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <Check className="w-5 h-5 shrink-0" style={{ color: '#52BE80' }} />
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold mb-4" style={{ color: '#15401E' }}>
                How MedFellow Aligns to the<br/>DHA Career Pathway
              </h2>
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
            ...
            <div className="bg-white p-8 md:p-12 rounded-2xl" style={{ border: '1px solid #E5E7EB' }}>
              ...
              <p className="text-sm" style={{ color: '#6B7280' }}>
                The practical takeaway: A MedFellow fellowship is not a substitute for DHA licensing exams. It is a credential that materially strengthens the specialist training section of your DHA application.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold mb-4" style={{ color: '#15401E' }}>
                Fully Online vs Hybrid Format:<br/>Which One Suits Dubai Doctors?
              </h2>
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white p-8 rounded-2xl" style={{ border: '2px solid #C8E6D0' }}>
                ...
                <p className="text-sm mb-4 leading-relaxed" style={{ color: '#6B7280' }}>
                  12 months, completely online. No India travel required. Never leave Dubai.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold mb-4" style={{ color: '#15401E' }}>
                Fees, EMI Options, and<br/>Payment Pathways for Dubai Applicants
              </h2>
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold mb-4" style={{ color: '#15401E' }}>
                How to Apply: A 5 Step<br/>Process for Dubai Based Doctors
              </h2>
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
            ...
            <div className="space-y-6 mb-8">
              {[
                ...
                },
                {
                  ...
                  description: "Book a 20-minute call with a MedFellow admissions advisor via WhatsApp or phone. Dubai applicants receive priority scheduling."
                },
                {
                  step: 3,
            ...
            <div className="p-8 rounded-2xl text-white text-center" style={{ background: 'linear-gradient(135deg, #15401E 0%, #15401E 100%)' }}>
              ...
              <p className="text-sm mb-6">Receive a priority decision within 72 hours for Dubai based applicants</p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-semibold mb-4" style={{ color: '#15401E' }}>
                Real Career Outcomes:<br/>Where MedFellow Fellows Work in Dubai
              </h2>
              <p className="text-lg leading-relaxed" style={{ color: '#6B7280' }}>
            ...
            <div className="bg-white p-8 md:p-12 rounded-2xl" style={{ border: '1px solid #E5E7EB' }}>
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <p className="text-sm" style={{ color: '#6B7280' }}>Transition from Medical Officer to Consultant at DHA or DOH hospitals</p>
                </div>
                <div className="text-center">
              ...
              <div className="p-6 rounded-xl border-t" style={{ borderColor: '#E5E7EB', background: '#e8f2ea' }}>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  The fellowship does not guarantee placement. It removes a credentialing barrier. Once that barrier is removed, the doctor's clinical experience in Dubai does the rest.
                </p>
              </div>
            </div>
          </div>
