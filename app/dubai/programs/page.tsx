              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderBottom: '1px solid #BFC9CA' }}>
                      <td className="px-6 py-4 text-sm" style={{ color: '#1B4F72' }}>Fit for Dubai Working Doctors</td>
                    ...
                    <tr style={{ borderBottom: '1px solid #BFC9CA' }}>
                      <td className="px-6 py-4 text-sm" style={{ color: '#1B4F72' }}>DHA CV Positioning</td>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm" style={{ color: '#5D6D7E' }}>Real clinical scenarios you encounter in Dubai practice</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <Check className="w-5 h-5 shrink-0" style={{ color: '#52BE80' }} />
            ...
            <div className="bg-white p-8 md:p-12 rounded-2xl" style={{ border: '1px solid #BFC9CA' }}>
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <p className="text-sm" style={{ color: '#5D6D7E' }}>Transition from Medical Officer to Consultant at DHA or DOH hospitals</p>
                </div>
                <div className="text-center">
