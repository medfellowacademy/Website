                    ...
                    <div className="space-y-8 animate-fade-in-up">
                      ...
                      <div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                          {[
                            { value: 'online_handson', label: 'Online + Hands-on Training', desc: 'In-depth clinical exposure with practical sessions', icon: '🏥' },
                            { value: 'online_only', label: 'Online Only', desc: 'Flexible digital learning from anywhere', icon: '💻' },
                          ].map(m => (
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                      ...
                      <div className="border border-gray-200 rounded-xl overflow-hidden">
                        <button type="button" onClick={() => setTermsOpen(v => !v)}
                          ...
                          <span className="text-sm font-semibold text-primary">📋 Terms & Conditions — Please Read</span>
                          <span className={`text-text-tertiary text-xs transition-transform duration-200 ${termsOpen ? 'rotate-180' : ''}`}>▼</span>
                        </button>
                        {termsOpen && (
                      ...
                      <div>
                        <p className="text-sm font-semibold text-primary mb-1">✍️ Declaration by Applicant</p>
                        ...
                        {!allDeclared && (
                          <p className="mt-3 text-xs text-accent font-medium flex items-center gap-1.5">
                            <span>⚠️</span> Please confirm all 6 declarations to submit.
                          </p>
                        )}
                      </div>
