...
export default async function ProgramDetailPage({ params }: { params: Promise<{ location: string; slug: string }> }) {
    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="container-custom py-20 text-center">
          ...
          <Link href={`/${location}/programs`} className="btn-primary px-8 py-3">
            View All Programs
          </Link>
        </div>
        <Footer />
...
export async function generateStaticParams() {
  ...
  // Generate params for each location and program combination
