...
export default function Faculty() {
  ...
  return (
    <section id="faculty" className="section-padding bg-linear-to-br from-white via-secondary/5 to-white relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute top-10 left-10 w-64 h-64 bg-primary/5 rounded-full blur-3xl animate-pulse-3d" />
      <div className="absolute bottom-10 right-10 w-80 h-80 bg-accent/5 rounded-full blur-3xl animate-pulse-3d [animation-delay:1.5s]" />
          ...
          {faculty.map((member, index) => (
            <div key={index} className="faculty-card">
              <FlipCard3D
                ...
                frontContent={
                  <div className="card p-8 h-full group hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      <div className="mb-6">
                        <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-primary to-secondary flex items-center justify-center mb-4 ring-4 ring-primary/20 group-hover:ring-accent/40 transition-all">
                ...
                backContent={
                  <div className="card h-full p-8 bg-linear-to-br from-primary to-secondary text-white relative overflow-hidden">
                    {/* Decorative pattern */}
